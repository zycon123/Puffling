...
16. Test Sky Treasure milestones, rare powerups and endless events.
...
## Performance check
Play a normal run for at least 2 minutes and one complete boss fight on mobile. There should be no progressive slowdown or severe input lag. Use `beta42.html`; other old beta test URLs should not be used for performance comparisons.
