...
- `store-assets/` + `scripts/generate-store-assets.mjs` — the opaque 1024×1024/512×512 store icons, Google Play 1024×500 feature graphic and validated 1080×1920 screenshot pipeline.
...
5. **Store listing screenshots:** The store icons and Google Play feature graphic are produced and CI-validated. Capture Gameplay, Boss, Race and Orbdex images from the reviewed signed build, then produce accepted iPhone sizes and iPad sizes if iPad remains supported, following `docs/STORE_ASSET_SPEC.md`.
