...
- PC Controls menu supports persistent keyboard rebinding for left/right/boost/pause and gamepad rebinding for action/back/pause, with one-click reset to defaults.
...
2. Complete packaged-hardware QA across Xbox, PlayStation and generic XInput-compatible controllers; user-configurable keyboard and core gamepad button rebinding is now implemented.
