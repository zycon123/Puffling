(function(){
 ...
 function recordBossDefeat(tier){if((tier||1)>=3)unlock('achBossHunter','BOSS HUNTER',1250);}
 const previousUpdate=update;
 update=function(dt){const hadBoss=!!boss,previousTier=hadBoss?(boss.tier||1):1;previousUpdate(dt);if(running)checkHeight();if(hadBoss&&!boss&&running&&previousTier>=3)recordBossDefeat(previousTier);};
 window.skyPuffAchievements={eventCleared,bossDefeated:recordBossDefeat,checkHeight};
})();
