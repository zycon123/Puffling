(function(){
 ...
 function inMultiplayerFlow(){try{if(typeof multiplayerMode!=='undefined'&&multiplayerMode)return true;if(typeof multiplayerState!=='undefined'&&multiplayerState&&multiplayerState!=='idle')return true;return false;}catch(e){return false;}}
 function repairOverlays(){if(!running&&!inMultiplayerFlow()&&startEl&&gameOverEl&&!visible(startEl)&&!visibleOverlay()){try{showMainMenu();log('No visible menu while game stopped','Main menu restored');return true;}catch(e){}}return false;}
