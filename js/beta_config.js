var SKY_PUFF_VERSION='5.26-beta.99';
...
var API_BASE=SKY_PUFF_GAME_API_URL;
try{var storedApiBase=String(localStorage.getItem('skyPuffApiBase')||'').trim();if(storedApiBase)API_BASE=storedApiBase;}catch(e){}
