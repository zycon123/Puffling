...
(function(){
 ...
 const GROUPS={
  ...
  more:[['dailyBtn','🎁','Daglig belønning'],['shopBtn','🎨','Cosmetics'],['upgradeBtn','⬆️','Oppgraderinger'],['achievementsBtn','🏅','Achievements'],['gameGuideBtn','📖','Spillguide'],['audioSettingsBtn','🔊','Lyd'],['pcControlsBtn','⌨️','Controls'],['diagnosticsBtn','🛠️','System & Support']]
 };
 let currentGroup='';
