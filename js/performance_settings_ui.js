...
(function(){
 ...
 function ensure(){
  ...
  row.innerHTML='<strong>Grafikkmodus</strong><div class="small" style="margin-top:4px">Auto anbefales. Low reduserer Orbuff-glow og effekter for bedre stabilitet.</div><div style="display:grid;grid-template-columns:repeat(3,1fr);gap:7px;margin-top:10px"><button data-spgfx="auto" class="secondary" style="padding:9px">AUTO</button><button data-spgfx="high" class="secondary" style="padding:9px">HIGH</button><button data-spgfx="low" class="secondary" style="padding:9px">LOW</button></div><div id="graphicsModeStatus" class="small" style="margin-top:9px;font-weight:900"></div>';
