...
(function(){
  ...
  function refreshHud(){ensureHud();const d=document.getElementById('activePufflingHud'),p=getPuff(active());if(!d)return;d.innerHTML=p?`${p.icon||'☁️'} ${p.name}`:'☁️ Ingen aktiv Orbuff';d.style.display=(typeof running!=='undefined'&&running)?'block':'none'}
