/* Orbuff — reward/economy hardening v1.2 (legacy identifiers retained) */
(function(){
 const DAY=86400000;
 ...
 function bossPuffNote(){const l=typeof lang==='string'?lang:'en';return({no:'Boss Orbuff kan brukes i Boss Rush. Beseir alle 10 bossene i Boss Rush for å låse den opp i hovedspillet.',en:'Boss Orbuff can be used in Boss Rush. Defeat all 10 bosses in Boss Rush to unlock it in the main game.',de:'Boss Orbuff kann im Boss Rush benutzt werden. Besiege alle 10 Bosse, um ihn im Hauptspiel freizuschalten.',es:'Boss Orbuff puede usarse en Boss Rush. Derrota a los 10 jefes para desbloquearlo en el juego principal.',fr:'Boss Orbuff peut être utilisé dans Boss Rush. Battez les 10 boss pour le débloquer dans le jeu principal.'})[l]||'Boss Orbuff can be used in Boss Rush. Defeat all 10 bosses in Boss Rush to unlock it in the main game.';}
