...
const checks = [
  ...
  ['default keyboard bindings retained', controls.includes("left:'KeyA'")&&controls.includes("right:'KeyD'")&&controls.includes("boost:'Space'")&&controls.includes("pause:'KeyP'")],
  ['Rainbow Boost binding action', controls.includes("action==='boost'")&&controls.includes('doBoost()')],
  ['pause/back binding actions', controls.includes("action==='pause'")&&controls.includes("event.code==='Escape'")],
