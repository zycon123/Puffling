...
for(const token of ['puffling.diamonds.25','puffling.diamonds.75','puffling.diamonds.250','puffling.diamonds.600','targetEur:1','targetEur:3','targetEur:9','targetEur:16','diamondBalance','verificationData','finishTransaction'])if(!source.includes(token))fail(`missing ${token}`);
...
console.log('✅ Diamond IAP pricing/scaffold validation passed');
