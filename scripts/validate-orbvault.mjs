...
V.settle();if(V.load().reviveOrbs!==1||!V.useReviveOrb()||V.load().reviveOrbs!==0)fail('Level 5 daily Revive Orb lifecycle failed');
console.log('✅ OrbVault validated: migration rest timer, upgrades, 3→8 slots, energy rest, passive XP and Revive Orb');