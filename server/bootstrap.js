...
(async()=>{
  ...
  const tradeInventoryStore=createTradeInventoryStore();
  ...
  const closeStores=()=>Promise.allSettled([iapStore.close(),leaderboardStore.close(),rankedStore.close(),tradeInventoryStore.close()]);
